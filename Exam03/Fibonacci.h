...
/**
 * @brief Initializes resources. This is optional: If you don't do it in advance, the
 * first call to Fibonacci() will.
*/
void InitFibonacci(void);

/**
 * @brief Releases resources. Should be called when you're done with Fibonacci.
 *
